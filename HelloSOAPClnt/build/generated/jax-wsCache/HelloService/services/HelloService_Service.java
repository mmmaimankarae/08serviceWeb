 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://myservice/", wsdlLocation = "http://localhost:8080/HelloSoapService/HelloService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://myservice/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HelloSoapService/HelloService?WSDL");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://myservice/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice/", "HelloServicePort"), HelloService.class, features);
    }
