 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://myservice/", wsdlLocation = "http://localhost:8080/EmployeeSoapService/EmployeeService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://myservice/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EmployeeSoapService/EmployeeService?WSDL");
    ...
    public EmployeeService getEmployeeServicePort() {
        return super.getPort(new QName("http://myservice/", "EmployeeServicePort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice/", "EmployeeServicePort"), EmployeeService.class, features);
    }
